...
Run:  uv run python examples/pydantic_ai_guard/demo.py
"""
...
from examples.pydantic_ai_guard.guard import CastorGuardedToolset, ToolRejectedError
from examples.pydantic_ai_guard.tools import (
    analyze_risk,
    check_portfolio,
    execute_trade,
    fetch_price,
