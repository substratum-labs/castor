...
Plain async functions — no decorators, no registry imports.
...
def make_tools(knowledge_base: Path) -> list:
    """Create all demo tools as plain functions.

    Returns a list suitable for ``Castor(tools=...)``.
    """
    ...
    return [web_search, read_notes, save_notes, send_email, save_draft]
